...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="../css/cadasterPubli.css">
    <link rel="stylesheet" href="../css/mediaQueries/cradastoCard.css">
    <script src="../admin/scripts/classes/front/Interatividade.js" defer></script>
    <script src="../admin/scripts/backManager.js" defer type="module"></script>
    ...
    <section>
      <div id="formCreatePubli">
        ...
        <!--<div>
          ...
          <button id="maisEmptySpc">Novo espaço em branco</button>
        </div>-->
        <button id="saveSketch" >Salvar rascunho</button>
        <button id="sendArticle" class="btnsPubli">Publicar</button>
      </div>
    </section>
